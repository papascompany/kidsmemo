...
process.env.KIDSMEMO_BOOTSTRAP_EMAIL =
  readEnv("KIDSMEMO_ADMIN_EMAIL") || "kidsmemo.admin.test@storige.co.kr";
process.env.KIDSMEMO_BOOTSTRAP_PASSWORD =
  readEnv("KIDSMEMO_ADMIN_PASSWORD") || "KidsmemoAdmin!2026";
process.env.KIDSMEMO_BOOTSTRAP_PROFILE_NAME =
  readEnv("KIDSMEMO_ADMIN_PROFILE_NAME") || "키즈메모 플랫폼 관리자";
process.env.KIDSMEMO_BOOTSTRAP_PHONE = readEnv("KIDSMEMO_ADMIN_PHONE") || "";
